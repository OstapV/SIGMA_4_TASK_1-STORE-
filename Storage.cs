...
namespace SIGMA_2
{
    class Storage
    {
        ...
        public Product this[int index]
        {
            ...
            set
            {
                if (index >= 0 && index < products.Length && value is Product)
        ...
        public void RemoveExpired()
        {
            try
            {
                ...
                Product[] expiredProducts = new Product[size];
                ...
                for (int i = 0; i < products.Length; i++)
                {
                    ...
                    if (products[i].GetType() == typeof(Dairy))
                    {
                        ...
                        if (dateNow.AddDays(products[i].ExpirationDate) > dateNow)
                        {
                            for (int j = 0; j < expiredProducts.Length; j++)
                            {
        ...
        public void ReadFromFile()
        {
            ...
            try
            {
                ...
                for (int i = 1, k = 0; i < 5 * products.Length; i += 5, k++)
                {
                       name = items[i];
